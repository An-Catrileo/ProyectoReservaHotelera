...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(PaymentController::class)->group(function () {
        Route::get('/payment/options/{code}', 'showPaymentOptions')->name('payment.options');
        Route::post('/payment/process/{code}', 'processPayment')->name('payment.process');
        Route::get('/payment/confirmation/{code}', 'showConfirmation')->name('payment.confirmation');
        Route::get('/payment/remaining/{code}', 'showRemainingPayment')->name('payment.remaining');
    });
...
// Añadir estas rutas para las pruebas
Route::post('/reservation/search', [ReservationController::class, 'searchRooms'])->name('reservation.search.room');
Route::post('/reservation/create', [ReservationController::class, 'createReservation'])->name('reservation.create');
Route::get('/reservation/{code}', [ReservationController::class, 'detailsReservation'])->name('reservation.details');
