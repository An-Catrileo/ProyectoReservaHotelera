...
const Footer = () => {
    ...
    const navigations = [
        { title: __('nav.home'), routeName: 'home' },
        { title: __('nav.about'), routeName: 'about' },
        { title: __('nav.rooms'), routeName: 'rooms' },
        { title: __('nav.gallery'), routeName: 'gallery' },
        { title: __('nav.legal'), routeName: 'legal-policies' },
        { title: __('nav.search_reservation'), routeName: 'search-reservation' },
    ]
    return (
            ...
            <div className='container text-base'>
                <div className='py-14 grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-y-10 md:gap-y-5 xl:gap-x-10'>
                    ...
                    <div className=' md:col-span-2 lg:col-span-3 xl:col-span-2'>
                        ...
                        <p className='mt-5'>
                            {__('footer.hotel_desc')}
                        </p>
                    </div>

                    <ItemFooter title={__('footer.quick_links')}>
                        <ul >
                    ...
                    <ItemFooter title={__('footer.contact_us')}>
                        <ul >
                            <li className='flex '>
